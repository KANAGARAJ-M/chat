...
import 'package:chat/features/chat/controllers/chat_controller.dart';
import 'package:chat/features/chat/models/message.dart';
import 'package:chat/features/chat/views/widgets/attachment_picker.dart';
import 'package:chat/features/chat/views/widgets/chat_date.dart';
import 'package:chat/features/chat/views/widgets/chat_field.dart';
import 'package:chat/features/chat/views/widgets/chat_mic.dart';
import 'package:chat/features/chat/views/widgets/message_cards.dart';
import 'package:chat/features/chat/views/widgets/scroll_btn.dart';
import 'package:chat/features/chat/views/widgets/voice_recorder.dart';
import 'package:chat/shared/models/user.dart';
import 'package:chat/shared/repositories/firebase_firestore.dart';
...
import 'package:chat/shared/widgets/bottom_inset.dart';
import 'package:chat/theme/color_theme.dart';
                ...
                SliverToBoxAdapter(
                  child: Center(
                    child: Container(
                      ...
                      child: Text(
                        '🔒Messages and calls are end-to-end encrypted. No one outside this chat, not even Chat UP, can read or listen to them. Tap to learn more.',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDarkTheme
